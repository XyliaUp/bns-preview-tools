...
public class Skeleton : IDisposable
{
	...
	public void UpdateAnimationMatrices(int currentSequence, int frameInSequence)
	{
		...
		{
			var transforms = _animatedBonesTransform[_previousAnimationSequence][boneIndex];
			if (transforms.Length > _previousSequenceFrame)
				_ssbo.Update(boneIndex, _invertedBonesMatrix[boneIndex] * transforms[_previousSequenceFrame].Matrix);
		}
