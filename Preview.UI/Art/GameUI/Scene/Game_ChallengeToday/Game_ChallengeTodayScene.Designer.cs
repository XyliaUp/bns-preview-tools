...
namespace Xylia.Preview.GameUI.Scene.Game_ChallengeToday
{
	partial class Game_ChallengeTodayScene
	{
		...
		private void InitializeComponent()
		{
			...
			this.RequiredTime = new Xylia.Preview.GameUI.Controls.ContentPanel();
			this.ChallengeToday_CompleteCount = new Xylia.Preview.GameUI.Controls.ContentPanel();
			this.ChallengeToday_TodayReward = new Xylia.Preview.GameUI.Controls.ContentPanel();
			this.ChallengeToday_TodayQuest = new Xylia.Preview.GameUI.Controls.ContentPanel();
			this.ChallengeToday_State = new Xylia.Preview.GameUI.Controls.ContentPanel();
