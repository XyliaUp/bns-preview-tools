...
namespace Xylia.Preview.GameUI.Scene.Game_ItemGrowth2
{
	partial class ItemSpiritPage
	{
		...
		private void InitializeComponent()
		{
			...
			this.AbilityInfo = new Xylia.Preview.UI.Custom.Controls.ContentPanel();
			this.GrowthState = new Xylia.Preview.UI.Custom.Controls.ContentPanel();
			this.ApplicablePartInfo = new Xylia.Preview.UI.Custom.Controls.ContentPanel();
		...
		private ContentPanel AbilityInfo;
		protected ContentPanel GrowthState;
		private ContentPanel ApplicablePartInfo;
	}
}
