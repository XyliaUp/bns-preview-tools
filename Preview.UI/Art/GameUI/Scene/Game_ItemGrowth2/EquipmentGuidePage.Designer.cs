...
namespace Xylia.Preview.GameUI.Scene.Game_ItemGrowth2
{
	partial class EquipmentGuidePage
	{
		...
		private void InitializeComponent()
		{
			...
			this.MyWeapon_Name = new Xylia.Preview.GameUI.Controls.ItemNameCell();
			this.MyWeapon_Icon = new Xylia.Preview.GameUI.Controls.ItemIconCell();
			...
			this.itemIconCell4 = new Xylia.Preview.GameUI.Controls.ItemIconCell();
			this.itemIconCell3 = new Xylia.Preview.GameUI.Controls.ItemIconCell();
		...
		protected ItemNameCell MyWeapon_Name;
	}
}