...
namespace Xylia.Preview.GameUI.Scene.Game_QuestJournal
{
	partial class BonusRewardPreview
	{
		...
		private void InitializeComponent()
		{
			...
			this.AttractionReward_ChanceNum = new Xylia.Preview.UI.Custom.Controls.ContentPanel();
			...
			this.CostToggle = new Xylia.Preview.UI.Custom.Controls.ContentPanel();
			...
			this.AttractionReward_ChargeChanceNum = new Xylia.Preview.UI.Custom.Controls.ContentPanel();
