...
public abstract class ItemAutomationPeer : AutomationPeer, IVirtualizedItemProvider
{
    ...
    ///
    protected ItemAutomationPeer(object item, SourceWidgetAutomationPeer itemsControlAutomationPeer) : base()
    {
        Item = item;
    ...
    override public object GetPattern(PatternInterface patternInterface)
    {
        if (patternInterface == PatternInterface.VirtualizedItem)
        {
            if (VirtualizedItemPatternIdentifiers.Pattern != null)
            {
                ...
                {
                    // SourceWidgetAutomationPeer can be null in case of TreeViewItems when parent TreeViewItem is also virtualized
                    // If the Item is in Automation Tree we consider it has Realized and need not return VirtualizeItem pattern.
                    if (SourceWidgetAutomationPeer != null && !IsItemInAutomationTree())
                    {
                        return this;
                    }

                    if (SourceWidgetAutomationPeer == null)
                        return this;
                }
            }
            return null;
    ...
    internal UIElement GetWrapper()
    {
        ...
        SourceWidgetAutomationPeer itemsControlAutomationPeer = SourceWidgetAutomationPeer;
        if (itemsControlAutomationPeer != null)
        {
            BnsCustomSourceBaseWidget owner = (BnsCustomSourceBaseWidget)itemsControlAutomationPeer.Owner;
            if (owner != null)
            {
                object item = RawItem;
    ...
    internal void ThrowElementNotAvailableException()
    {
        ...
        if (VirtualizedItemPatternIdentifiers.Pattern != null && !(this is GridViewItemAutomationPeer) && !IsItemInAutomationTree())
            throw new ElementNotAvailableException("VirtualizedElement");
    }
    ...
    /// this method will calculate the position of an item based on its parent BnsCustomSourceBaseWidget,
    /// if the BnsCustomSourceBaseWidget is grouping the position will be relative to the group containing this item.
    /// </remarks>
    /// <returns>
    /// The value of <see cref="AutomationProperties.PositionInSetProperty"/> if it has been set, or it's position relative to the parent BnsCustomSourceBaseWidget or GroupItem.
    /// </returns>
    protected override int GetPositionInSetCore()
    {
        ...
        //	{
        //		BnsCustomSourceBaseWidget parentBnsCustomSourceBaseWidget = (BnsCustomSourceBaseWidget)SourceWidgetAutomationPeer.Owner;
        //		position = GetPositionInSetFromBnsCustomSourceBaseWidget(parentBnsCustomSourceBaseWidget, Item);
        //	}
    ...
    /// this method will calculate the size of the set containing this item based on its parent BnsCustomSourceBaseWidget,
    /// if the BnsCustomSourceBaseWidget is grouping the value will be representative of the group containing this item.
    /// </remarks>
    /// <returns>
    /// The value of <see cref="AutomationProperties.SizeOfSetProperty"/> if it has been set, or the size of the parent BnsCustomSourceBaseWidget or GroupItem.
    /// </returns>
    protected override int GetSizeOfSetCore()
    {
        ...
        //	{
        //		BnsCustomSourceBaseWidget parentBnsCustomSourceBaseWidget = (BnsCustomSourceBaseWidget)SourceWidgetAutomationPeer.Owner;
        //		size = GetSizeOfSetFromBnsCustomSourceBaseWidget(parentBnsCustomSourceBaseWidget, Item);
        //	}
        ...
        return AutomationSizeOfSetDefault;
    }

    internal static int GetPositionInSetFromBnsCustomSourceBaseWidget(BnsCustomSourceBaseWidget itemsControl, object item)
    {
        int position = AutomationPositionInSetDefault;
    ...
    internal static int GetSizeOfSetFromBnsCustomSourceBaseWidget(BnsCustomSourceBaseWidget itemsControl, object item)
    {
    ...
    private static int FindPositionInGroup(ReadOnlyObservableCollection<object> collection, int position, out int sizeOfGroup)
    {
        ...
        sizeOfGroup = AutomationSizeOfSetDefault;
        //do
        //{
        //	newCollection = null;
    ...
    protected override string GetAutomationIdCore()
    {
        ...
        {
            using (RecyclableWrapper recyclableWrapper = SourceWidgetAutomationPeer.GetRecyclableWrapperPeer(item))
            {
    ...
    protected override string GetNameCore()
    {
        ...
        else if (item != null && SourceWidgetAutomationPeer is { } itemsControlAutomationPeer)
        {
    ...
    virtual internal SourceWidgetAutomationPeer GetSourceWidgetAutomationPeer()
    {
    ...
    // Rebuilding the "item" children of an BnsCustomSourceBaseWidgetAP or GroupItemAP re-uses
    ...
    {
        Debug.Assert(Equals(item, Item), "ItemPeer reuse for an unequal item is not supported");
        ItemWeakReference iwr = _item as ItemWeakReference;
        if (iwr != null)
        {
            if (!ReferenceEquals(item, iwr.Target))
            {
                iwr.Target = item;
            }
        }
    ...
    ///
    public SourceWidgetAutomationPeer SourceWidgetAutomationPeer
    {
        get
        {
            return GetSourceWidgetAutomationPeer();
        }
        internal set
        {
    ...
    virtual internal void RealizeCore()
    {
        ...
        //if (itemsControlAutomationPeer != null)
        //{
        //	BnsCustomSourceBaseWidget parent = itemsControlAutomationPeer.Owner as BnsCustomSourceBaseWidget;
        //	if (parent != null)
        //	{
    ...
    private SourceWidgetAutomationPeer _itemsControlAutomationPeer;
...
// work around (BnsCustomSourceBaseWidget.GroupStyle doesn't show items in groups in the UIAutomation tree)
// this class should be public
internal class SourceWidgetItemAutomationPeer : ItemAutomationPeer
{
    public SourceWidgetItemAutomationPeer(object item, SourceWidgetWrapperAutomationPeer parent)
        : base(item, parent)
    { }
    ...
    {
        return "BnsCustomSourceBaseWidgetItem";
    }
}