...
internal class NameTableBuilder
{
	private readonly NameTable _target;
	private readonly Node _rootNode;

	internal NameTableBuilder(NameTable target)
	{
	...
	public NameTableBuilder AddTable<T>(string tableprefix, ICollection<T> records) where T : IHaveAlias, IRecord
	{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public void AddAliasManually(AliasEntry record)
	{
		Add(_rootNode, record.Ref, record.Table + ":" + record.Alias);
	}
