...
using Xylia.Preview.Data.Record.ReactionClass;

using static Xylia.Preview.Data.Record.Reaction;
...
public sealed class ReactionSet : BaseRecord
{
    ...
    public override void LoadData(XmlElement data)
    {
        ...
        foreach (var record in data.SelectNodes("./reaction").OfType<XmlElement>())
        {
            ...
            //Reaction.Add(record.TypeFactory<ReactionType, Reaction>(s => s switch
            //{
