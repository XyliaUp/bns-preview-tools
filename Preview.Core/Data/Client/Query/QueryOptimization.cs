...
internal class QueryOptimization
{
	...
	public QueryOptimization(Query query, IEnumerable<AttributeDocument> source, Collation collation)
	{
		ArgumentNullException.ThrowIfNull(query.Select);

		_query = query;
		_collation = collation;

		_queryPlan = new QueryPlan(null)
		{
