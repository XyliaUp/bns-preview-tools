...
/// </summary>
internal delegate IEnumerable<AttributeValue> BsonExpressionEnumerableDelegate(IEnumerable<AttributeDocument> source, AttributeDocument root, AttributeValue current, Collation collation, AttributeDocument parameters);

/// <summary>
/// Delegate function to get compiled scalar expression
/// </summary>
internal delegate AttributeValue BsonExpressionScalarDelegate(IEnumerable<AttributeDocument> source, AttributeDocument root, AttributeValue current, Collation collation, AttributeDocument parameters);

/// <summary>
/// Compile and execute string expressions using AttributeDocuments. Used in all document manipulation (transform, filter, indexes, updates). See https://github.com/mbdavid/LiteDB/wiki/Expressions
/// </summary>
public sealed class BsonExpression
{
    ...
    /// </summary>
    public AttributeDocument Parameters { get; internal set; }
    ...
    /// <summary>
    /// This expression has no dependency of AttributeDocument so can be used as user value (when select index)
    /// </summary>
    ...
    /// <summary>
    /// Get default field name when need convert simple AttributeValue into AttributeDocument
    /// </summary>
    ...
    /// </summary>
    public IEnumerable<AttributeValue> Execute(Collation collation = null)
    {
        var root = new AttributeDocument();
        var source = new AttributeDocument[] { root };
    ...
    /// </summary>
    public IEnumerable<AttributeValue> Execute(AttributeDocument root, Collation collation = null)
    {
    ...
    /// Execute expression and returns IEnumerable values
    /// </summary>
    public IEnumerable<AttributeValue> Execute(IEnumerable<AttributeDocument> source, Collation collation = null)
    {
    ...
    /// </summary>
    internal IEnumerable<AttributeValue> Execute(IEnumerable<AttributeDocument> source, AttributeDocument root, AttributeValue current, Collation collation)
    {
        if (this.IsScalar)
        {
    ...
    /// </summary>
    internal IEnumerable<AttributeValue> GetIndexKeys(AttributeDocument doc, Collation collation)
    {
    ...
    /// </summary>
    public AttributeValue ExecuteScalar(Collation collation = null)
    {
        var root = new AttributeDocument();
        var source = new AttributeDocument[] { };
    ...
    /// </summary>
    public AttributeValue ExecuteScalar(AttributeDocument root, Collation collation = null)
    {
		ArgumentNullException.ThrowIfNull(root);
    ...
    /// </summary>
    public AttributeValue ExecuteScalar(IEnumerable<AttributeDocument> source, Collation collation = null)
    {
		ArgumentNullException.ThrowIfNull(source);
    ...
    /// Execute expression and returns IEnumerable values - returns NULL if no elements
    /// </summary>
    internal AttributeValue ExecuteScalar(IEnumerable<AttributeDocument> source, AttributeDocument root, AttributeValue current, Collation collation)
    {
        if (this.IsScalar)
        {
    ...
    {
        return Create(expression, new AttributeDocument());
    }

    /// <summary>
    /// Parse string and create new instance of BsonExpression - can be cached
    /// </summary>
    public static BsonExpression Create(string expression, params AttributeValue[] args)
    {
        var parameters = new AttributeDocument();
    ...
    /// </summary>
    internal static BsonExpression Create(Tokenizer tokenizer, BsonExpressionParserMode mode, AttributeDocument parameters)
    {
    ...
    /// </summary>
    internal static BsonExpression ParseAndCompile(Tokenizer tokenizer, BsonExpressionParserMode mode, AttributeDocument parameters, DocumentScope scope)
    {
		ArgumentNullException.ThrowIfNull(tokenizer);
    ...
    /// </summary>
    internal static void SetParameters(BsonExpression expr, AttributeDocument parameters)
    {
